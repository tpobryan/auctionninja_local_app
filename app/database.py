...
def item_record_from_form(lot_number: int, form: dict[str, str], image_folder: str) -> dict[str, str]:
    return {
        ...
        "platform_data": json.dumps({
            ...
            "ebay_fulfillment_policy_id": form.get("eBay Fulfillment Policy ID", ""),
            "ebay_payment_policy_id": form.get("eBay Payment Policy ID", ""),
            "ebay_return_policy_id": form.get("eBay Return Policy ID", ""),
            "ebay_condition": form.get("eBay Condition", "USED_EXCELLENT"),
            ...
            "poshmark_brand": form.get("Poshmark Brand", ""),
...
def fetch_manage_items(status_filter: str = "active") -> list[dict[str, str]]:
    ...
    try:
        ...
        cursor.execute(
            ...
            LEFT JOIN item_platform_status ips ON ai.lot_number = ips.lot_number AND ai.auction_id = ips.auction_id
