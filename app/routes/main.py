...
def render_edit_page(
    ...
    try:
        ...
        current_app.logger.warning("[Main] Failed to fetch Etsy shipping profiles: %s", exc)
...
def save():
    ...
    should_upload_ftp = (form.get("Listing Strategy") == "auction") or (form.get("Publish to eBay") == "yes")
    
    if auction_number and should_upload_ftp:
        try:
